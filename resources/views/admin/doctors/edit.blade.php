                    ...
                    <div class="row">
                        ...
                        @foreach ($specialtiesArray as $i => $specialty)
                            ...
                            <div class="form-check">
                                ...
                                <label for="specialty{{ $i }}" class="form-check-label">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h3 class="modal-title fs-5" id="deleteLabel">La cancellazione del profilo è
                            irreversibile, sicuro di voler continuare?</h3>
